...
impl Display for ScalarKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ScalarKind::Bool(obj) => write!(f, "{}", obj),
            ScalarKind::Char(obj) => write!(f, "{}", obj),
            ScalarKind::Short(obj) => write!(f, "{}", obj),
            ScalarKind::Int(obj) => write!(f, "{}", obj),
            ScalarKind::Long(obj) => write!(f, "{}", obj),
            ScalarKind::Date(obj) => write!(f, "{}", obj),
            ScalarKind::Month(obj) => write!(f, "{}", obj),
            ScalarKind::Time(obj) => write!(f, "{}", obj),
            ScalarKind::Minute(obj) => write!(f, "{}", obj),
            ScalarKind::Second(obj) => write!(f, "{}", obj),
            ScalarKind::DateTime(obj) => write!(f, "{}", obj),
            ScalarKind::TimeStamp(obj) => write!(f, "{}", obj),
            ScalarKind::NanoTime(obj) => write!(f, "{}", obj),
            ScalarKind::NanoTimeStamp(obj) => write!(f, "{}", obj),
            ScalarKind::Float(obj) => write!(f, "{}", obj),
            ScalarKind::Double(obj) => write!(f, "{}", obj),
            ScalarKind::String(obj) => write!(f, "{}", obj),
            ScalarKind::DateHour(obj) => write!(f, "{}", obj),
        }
    }
}
